  ...
  return (
    <ProjectSummary
      ...
      description={
        <>
          <p>
            A modern webapp take on a PokéDex from the Pokémon video game series
            I made with a few friends that allows users to build and share
            Pokémon teams.
          </p>
          <p>
            Users can browse the Pokédex to look at Pokémon stats, types and
            descriptions. They can also view, upvote, and comment on posted
            teams.
          </p>
      ...
      links={[
        <a
          ...
          href={"https://github.com/seif-y/PokeBuilder"}
        >
