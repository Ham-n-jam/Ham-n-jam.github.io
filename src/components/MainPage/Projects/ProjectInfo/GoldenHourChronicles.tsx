  ...
  return (
    <ProjectSummary
      ...
      description={
        <>
          <p>
            This is my long-term project: An old-school Zelda-like 2D top-down
            action adventure game.
          </p>
          <p>
            Follow Zach and his allies on a journey across the Kingdom of
            Eulyssia to uncover the true nature of the world.
          </p>
          <p>
            I'm currently developing Golden Hour Chronicles for Windows and I
            intend to release it as a commercial product on Steam.
          </p>
      ...
      links={[
        <a
          ...
          href={"https://twitter.com/GoldenHourC"}
        >
