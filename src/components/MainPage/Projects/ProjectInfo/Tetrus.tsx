  ...
  return (
    <ProjectSummary
      ...
      description={
        <>
          <p>
            My first crack at using the Godot Engine, it's the classic
            block-stacker game with a twist.
          </p>
          <p>
            Enjoy hectic gameplay as 1-4 players all play on the same board
            simultaneously!
          </p>
