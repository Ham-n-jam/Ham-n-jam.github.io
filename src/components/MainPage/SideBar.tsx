    ...
    <>
      <div className={styles.navbar}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.bg}>
            <div>
              ...
              <div className={styles.info}>Software Engineer</div>
              <div>
              ...
              <div>
                <a className={styles.link} href="tel:0468583505">
                  <MdPhone className={"icon"} /> 0468 583 505
                </a>
              </div>
              <div>
        ...
        <div className={styles.cvDownload}>
          <a
            className={`${styles.link} ${styles.blackText}`}
            href={`${process.env.PUBLIC_URL}/files/Alex_Bell_CV.pdf`}
            download="Alex_Bell_CV"
          >
            <Button
              text={
                <>
